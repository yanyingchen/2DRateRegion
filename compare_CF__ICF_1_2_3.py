...
#         self.fco_region = cs.FCo_scheme(P3, P4) # FCo
        ...
        self.icf02_region_bigR1 = cs.ICF_sch2_bigR1(P3, P4) # ICF Scheme 2
        self.icf02_region_bigR2 = cs.ICF_sch2_bigR2(P3, P4)
...
#         self.df_fco_region = cs.TwoHops_DFIntegerCoeff_FCo_fromRegions(self.df_region, self.fco_region)
        ...
        self.cf_icf02_region = cs.TwoHops_CF_ICFsch2_fromRegions(self.icf02_region_bigR1, self.icf02_region_bigR2, self.cf_region) 
